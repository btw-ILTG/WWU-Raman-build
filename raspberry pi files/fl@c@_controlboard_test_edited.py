...
if __name__ == '__main__':
    ...
    while 1 :
        try:
           ...
           cmd_tray_open = (chr(0xF0)+chr(0xF2)+chr(0XB0)+chr(0xB1)+chr(0xF2)+chr(0xF3))
           ...
           cmd_tray_close = (chr(0xF0)+chr(0xF2)+chr(0XB0)+chr(0xB2)+chr(0xF2)+chr(0xF3))
           serial.write(cmd_tray_close)
 
           time.sleep(7)
 
           print "Command Filter Select:"
           cmd_filter_select = (chr(0xF0)+chr(0xF2)+chr(0XC0)+chr(0xC2)+chr(0xF2)+chr(0xF3))
